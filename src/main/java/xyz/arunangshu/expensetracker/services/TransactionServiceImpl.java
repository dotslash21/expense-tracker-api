...
import xyz.arunangshu.expensetracker.repositories.TransactionRepository;
...
public class TransactionServiceImpl implements TransactionService {
  ...
  public Transaction addTransaction(Integer userId, Integer categoryId, Double amount, String note,
    ...
    int transactionId = transactionRepository
        .create(userId, categoryId, amount, note, transactionDate);
    return transactionRepository.findById(userId, categoryId, transactionId);
  }
